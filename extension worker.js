...
/***/ "../../node_modules/scratch-vm/src/extension-support/extension-worker.ts":
/*!*********************************************************************************************************!*\
  !*** /home/runner/work/editor/editor/node_modules/scratch-vm/src/extension-support/extension-worker.ts ***!
  \*********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../node_modules/scratch-vm/src/extension-support/tw-jquery-shim.ts":
/*!*******************************************************************************************************!*\
  !*** /home/runner/work/editor/editor/node_modules/scratch-vm/src/extension-support/tw-jquery-shim.ts ***!
  \*******************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
let jsonpCallback = 0;
jQuery.ajax = (arg1, arg2) => __awaiter(void 0, void 0, void 0, function* () {
    let options = {};
    if (arg1 && arg2) {
        options = arg2;
    ...
    try {
        ...
        const res = yield fetch(getFinalURL(), {
        ...
        successCallback(yield res.json());
    }
    catch (e) {
        errorCallback(e);
    }
...
"use strict";
/* WEBPACK VAR INJECTION */(function(global) {
const context = __webpack_require__(/*! ./tw-extension-worker-context */ "../../node_modules/scratch-vm/src/extension-support/tw-extension-worker-context.ts");
const jQuery = __webpack_require__(/*! ./tw-jquery-shim */ "../../node_modules/scratch-vm/src/extension-support/tw-jquery-shim.ts");
// @ts-expect-error TS(7017): Element implicitly has an 'any' type because type ... Remove this comment to see the full error message
global.$ = jQuery;
...
__webpack_require__(/*! ./extension-worker */ "../../node_modules/scratch-vm/src/extension-support/extension-worker.ts");
