            ...
            <div className={styles.optionsRow}>
                ...
                >
                    ...
                    <div className={styles.optionTitle}>
                        <FormattedMessage
                            defaultMessage="Add an input"
                            description="Label for button to add a lambda input"
                            id="gui.customProcedures.addAnInputLambda"
                        />
                    </div>
                    <div className={styles.optionDescription}>
                        <FormattedMessage
                            defaultMessage="lambda"
                            description="Description of the lambda input type"
                            id="gui.customProcedures.lambdaType"
                        />
                    </div>
                </div>
                <div
...
CustomProcedures.propTypes = {
    ...
    onAddLambda: PropTypes.func.isRequired,
