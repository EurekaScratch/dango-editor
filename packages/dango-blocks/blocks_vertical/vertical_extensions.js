...
/**
 * Extension to make represent a lambda reporter in Scratch-Blocks.
 * That means the block has a branch, a round output shape, and a 'String'
 * output type.
 * @this {Blockly.Block}
 * @readonly
 */
Blockly.ScratchBlocks.VerticalExtensions.OUTPUT_LAMBDA = function() {
  this.setInputsInline(true);
  this.setOutputShape(Blockly.SHAPE_STATEMENT);
  this.setOutput(true, 'Lambda');
};
...
Blockly.ScratchBlocks.VerticalExtensions.registerAll = function() {
  ...
  Blockly.Extensions.register('output_lambda',
    Blockly.ScratchBlocks.VerticalExtensions.OUTPUT_LAMBDA);
