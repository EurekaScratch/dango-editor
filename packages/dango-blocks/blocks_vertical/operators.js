...
Blockly.Blocks['operator_lambda'] = {
  /**
   * Block for creating a lambda expression by wrapping blocks.
   * @this Blockly.Block
   */
  init: function() {
    this.jsonInit({
      "message0": Blockly.Msg.OPERATORS_LAMBDA,
      "message1": "%1",
      "args1": [
        {
      ...
      "extensions": ["colours_operators", "output_lambda"]
    });
  }
};

Blockly.Blocks['operator_lambda_param'] = {
  /**
  ...
  init: function() {
    this.jsonInit({
      "message0": Blockly.Msg.OPERATORS_LAMBDA_PARAM,
      "args0": [
        {
          "type": "input_value",
          "name": "INDEX"
      ...
      "category": Blockly.Categories.operators,
      "extensions": ["colours_operators", "output_number", "output_string"]
    });
  }
};
