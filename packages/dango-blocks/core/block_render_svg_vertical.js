...
/**
 * Width of empty lambda input shape.
 * @const
 */
Blockly.BlockSvg.INPUT_SHAPE_LAMBDA_WIDTH = 12 * Blockly.BlockSvg.GRID_UNIT;
...
/**
 * SVG path for an empty lambda input shape.
 * @const
 */

Blockly.BlockSvg.INPUT_SHAPE_LAMBDA =
  'M ' + (5 * Blockly.BlockSvg.GRID_UNIT) + ',0' +
  ' l ' + (-4 * Blockly.BlockSvg.GRID_UNIT) + ','  + (Math.sqrt(48) * Blockly.BlockSvg.GRID_UNIT) +
  ' h ' + (8 * Blockly.BlockSvg.GRID_UNIT) +
  ' l ' + (-4 * Blockly.BlockSvg.GRID_UNIT) + ',' + (-1 * Math.sqrt(48) * Blockly.BlockSvg.GRID_UNIT) +
  ' z';
...
Blockly.BlockSvg.prototype.computeInputWidth_ = function(input) {
  ...
  if (input.type == Blockly.INPUT_VALUE &&
    ...
    switch (input.connection.getOutputShape()) {
      case Blockly.OUTPUT_SHAPE_LAMBDA:
        return Blockly.BlockSvg.INPUT_SHAPE_LAMBDA_WIDTH;
...
Blockly.BlockSvg.prototype.renderDraw_ = function(iconWidth, inputRows) {
  ...
  if (this.outputConnection) {
    ...
    var shape = this.getOutputShape();
    if (shape === Blockly.OUTPUT_SHAPE_HEXAGONAL || shape === Blockly.OUTPUT_SHAPE_ROUND  || shape === Blockly.OUTPUT_SHAPE_LAMBDA) {
...
Blockly.BlockSvg.getInputShapeInfo_ = function(shape) {
  ...
  switch (shape) {
    ...
    case Blockly.OUTPUT_SHAPE_LAMBDA:
      ...
      inputShapeWidth = Blockly.BlockSvg.INPUT_SHAPE_LAMBDA_WIDTH;
