...
class Target extends EventEmitter {
     ...
     * @constructor
     */
    constructor (runtime: Runtime, blocks?: Blocks) {
        super();
        if (!blocks) {
     ...
     */
    updateEdgeActivatedValue (blockId: any, newValue: any) {
        const oldValue = this._edgeActivatedHatValues[blockId];
        this._edgeActivatedHatValues[blockId] = newValue;
        return oldValue;
    }
    hasEdgeActivatedValue (blockId: any) {
     ...
     */
    lookupOrCreateVariable (id: any, name: any) {
     ...
     * @return {?Variable} Variable object.
     */
    lookupBroadcastMsg (id: any, name: any) {
        let broadcastMsg;
        if (id) {
     ...
     * @return {?Variable} Variable object.
     */
    lookupBroadcastByInputValue (name: any) {
     ...
     */
    lookupVariableByNameAndType (name: any, type: any, skipStage: any) {
    ...
    * @return {!Varible} Variable object representing the found/created list.
     */
    lookupOrCreateList (id: any, name: any) {
     ...
     */
    createVariable (id: any, name: any, type: any, isCloud: any) {
        if (!this.variables.hasOwnProperty(id)) {
     ...
     */
    createComment (id: any, blockId: any, text: any, x: any, y: any, width: any, height: any, minimized: any) {
     ...
     */
    renameVariable (id: any, newName: any) {
        if (this.variables.hasOwnProperty(id)) {
            ...
            if (variable.id === id) {
                ...
                if (this.runtime) {
                    ...
                    if (variable.type === Variable.SCALAR_TYPE) {
                        ...
                        this.runtime.targets.forEach((t: any) => {
     ...
     */
    duplicateVariable (id: any, optKeepOriginalId: any) {
        if (this.variables.hasOwnProperty(id)) {
     ...
     */
    duplicateVariables (optBlocks: any) {
        let allVarRefs: any;
        if (optBlocks) {
     ...
     */
    setCustomState (stateId: any, newValue: any) {
     ...
     */
    getAllVariableNamesInScopeByType (type: any, skipStage: any) {
        if (typeof type !== 'string') {
            type = Variable.SCALAR_TYPE;
        }
        skipStage = skipStage || false;
     ...
     */
    mergeVariables (idToBeMerged: any, idToMergeWith: any, optReferencesToUpdate: any, optNewName: any) {
     ...
     */
    shareLocalVariableToStage (varId: any, varRefs: any) {
        if (!this.runtime) {
            return;
        }
     ...
     */
    shareLocalVariableToSprite (varId: any, sprite: any, varRefs: any) {
        if (!this.runtime) {
            return;
        }
        if (this.isStage) {
     ...
     */
    resolveVariableSharingConflictsWithTarget (blocks: any, receivingTarget: any) {
        if (this.isStage) {
            return;
        }
    ...
    fixUpVariableReferences () {
        ...
        const renameConflictingLocalVar = (id: any, name: any, type: any) => {
        ...
        if (Object.keys(this.variables).length > 0) {
            for (const localVarId in this.variables) {
                if (!this.variables.hasOwnProperty(localVarId)) {
                    continue;
                }
            ...
            if (this.lookupVariableById(varId)) {
                ...
                if (this.variables.hasOwnProperty(varId)) {
                    ...
                    if (newVarName) {
                        ...
                        allReferences[varId].map((ref: any) => {
        ...
        for (const conflictId in conflictNamesToReplace) {
            ...
            const referencesToUpdate = allReferences[conflictId];
            referencesToUpdate.map((ref: any) => {
