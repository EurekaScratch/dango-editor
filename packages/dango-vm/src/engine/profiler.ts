...
class Profiler {
  ...
  */
 start (id: number, arg?: any) {
     // @ts-expect-error TS(2339): Property 'now' does not exist on type 'false | Per... Remove this comment to see the full error message
 ...
 * @const {number}
 */
// @ts-expect-error TS(2339): Property 'START' does not exist on type 'typeof Pr... Remove this comment to see the full error message
Profiler.START = START;
/**
 * A reference to the STOP record id constant.
 * @const {number}
 */
// @ts-expect-error TS(2339): Property 'STOP' does not exist on type 'typeof Pro... Remove this comment to see the full error message
Profiler.STOP = STOP;
