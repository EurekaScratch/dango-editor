 ...
 * @constructor
 */
class Scratch3MusicBlocks implements StandardScratchExtensionClass {
    _bufferSources: any;
    _concurrencyCounter: any;
    _drumPlayers: any;
     ...
     */
    _storeSound (filePath: any, index: any, playerArray: any) {
     ...
     */
    _buildMenu (info: any) {
        return info.map((entry: any, index: any) => {
            const obj = {};
     ...
     */
    playDrumForBeats (args: any, util: any) {
     ...
     * @param {object} util - utility object provided by the runtime.
     */
    midiPlayDrumForBeats (args: any, util: any) {
     ...
     * @param {object} util - utility object provided by the runtime.
     */
    _playDrumForBeats (drumNum: any, beats: any, util: any) {
     ...
     * @private
     */
    _playDrumNum (util: any, drumNum: any) {
     ...
     */
    restForBeats (args: any, util: any) {
        if (this._stackTimerNeedsInit(util)) {
     ...
     */
    playNoteForBeats (args: any, util: any) {
        if (this._stackTimerNeedsInit(util)) {
    ...
    _playNoteForPicker (noteNum: any, category: any) {
     ...
     * @private
     */
    _playNote (util: any, note: any, durationSec: any) {
        if (util.runtime.audioEngine === null) {
            return;
        }
        if (util.target.sprite.soundBank === null) {
     ...
     * @private
     */
    _selectSampleIndexForNote (note: any, samples: any) {
     ...
     * @private
     */
    _ratioForPitchInterval (interval: any) {
     ...
     * @private
     */
    _startStackTimer (util: any, duration: any) {
     ...
     */
    setInstrument (args: any, util: any) {
     ...
     */
    midiSetInstrument (args: any, util: any) {
     ...
     */
    _setInstrument (instNum: any, util: any, mapMidi: any) {
        const musicState = this._getMusicState(util.target);
