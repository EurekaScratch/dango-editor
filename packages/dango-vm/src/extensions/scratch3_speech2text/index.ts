...
class Scratch3Speech2TextBlocks {
    ...
    _socket: any;
    _sourceNode: any;
    _speechFinalResponseTimeout: any;
    _speechPromises: any;
    _speechTimeoutId: any;
    _utteranceForEdgeTrigger: any;
    runtime: any;
    ...
    _scanBlocksForPhraseList () {
        ...
        this.runtime.targets.forEach((target: any) => {
            target.blocks._scripts.forEach((id: any) => {
     ...
     * @private
     */
    _shouldKeepResult (fuzzyMatchIndex: any, result: any, normalizedTranscript: any) {
     ...
     */
    _computeFuzzyMatch (text: any, pattern: any) {
     ...
     * @private
     */
    _processTranscriptionResult (result: any) {
     ...
     * @private
     */
    _onTranscriptionFromServer (e: any) {
        let result = null;
        try {
     ...
     * @private
     */
    _speechMatches (pattern: any, text: any) {
    ...
    _initializeMicrophone () {
        ...
        this._audioPromise.then().catch((e: any) => {
     ...
     */
    _newSocketCallback (resolve: any, reject: any) {
     ...
     */
    _setupSocketCallback (values: any) {
    ...
    _processAudioCallback (e: any) {
        ...
        // integer.
        this._socket.send(Int16Array.from(floatSamples.map((n: any) => n * MAX_INT)));
    }
