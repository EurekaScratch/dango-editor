 ...
 * @constructor
 */
class Scratch3Text2SpeechBlocks implements StandardScratchExtensionClass {
    _soundPlayers: any;
     ...
     */
    _getExtensionLocaleForSupportedLocale (locale: any) {
     ...
     */
    isSupportedLanguage (languageCode: any) {
     ...
     */
    _stopAllSpeech () {
        this._soundPlayers.forEach((player: any) => {
            player.stop();
        });
    }
    /**
     ...
     */
    speakAndWait (args: any, util: any) {
