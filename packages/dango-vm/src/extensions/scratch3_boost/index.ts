 ...
 */
const numberToInt32Array = function (number: any) {
 ...
 */
const int32ArrayToNumber = function (array: any) {
...
class BoostMotor {
    ...
    _index: any;
    _parent: any;
    _pendingDurationTimeoutDelay: any;
    _pendingDurationTimeoutId: any;
    _pendingDurationTimeoutStartTime: any;
    _pendingRotationDestination: any;
    _pendingRotationPromise: any;
    _position: any;
    _power: any;
    _status: any;
    /**
     ...
     */
    constructor (parent: any, index: any) {
        /**
     ...
     */
    turnOnForDegrees (degrees: any, direction: any) {
    ...
    turnOff (useLimiter = true) {
        const cmd = this._parent.generateOutputCommand(this._index, BoostOutputExecution.EXECUTE_IMMEDIATELY, BoostOutputSubCommand.START_POWER, [
     ...
     * @private
     */
    _setNewDurationTimeout (callback: any, delay: any) {
        this._clearDurationTimeout();
...
class Boost {
     ...
     */
    stopAllMotors () {
        this._motors.forEach((motor: any) => {
            if (motor) {
    ...
    setLED (inputRGB: any) {
        ...
        const cmd = this.generateOutputCommand(this._ports.indexOf(BoostIO.LED), BoostOutputExecution.EXECUTE_IMMEDIATELY ^ BoostOutputExecution.COMMAND_FEEDBACK, BoostOutputSubCommand.WRITE_DIRECT_MODE_DATA, [BoostMode.LED,
            ...rgb]);
     ...
     */
    send (uuid: any, message: any, useLimiter = true) {
        if (!this.isConnected()) {
     ...
     */
    generateOutputCommand (portID: any, execution: any, subCommand: any, payload: any) {
        const hubID = 0x00;
     ...
     */
    generateInputCommand (portID: any, mode: any, delta: any, enableNotifications: any) {
        const command = [
            0x00,
        ...
        case BoostMessage.PORT_VALUE: {
            ...
            case BoostIO.COLOR:
                ...
                if (this._colorSamples.length > BoostColorSampleSize) {
                    ...
                    if (this._colorSamples.every((v: any, i: any, arr: any) => v === arr[0])) {
     ...
     * @private
     */
    _registerSensorOrMotor (portID: any, type: any) {
 ...
 */
class Scratch3BoostBlocks implements StandardScratchExtensionClass {
    _peripheral: any;
    runtime: any;
    /**
    ...
    motorOnFor (args: any) {
        ...
        return new Promise(resolve => {
            this._forEachMotor(args.MOTOR_ID, (motorIndex: any) => {
    ...
    motorOnForRotation (args: any) {
         ...
         */
        // @ts-expect-error TS(7006): Parameter 'portID' implicitly has an 'any' type.
     ...
     * @private
     */
    _forEachMotor (motorID: any, callback: any) {
        let motors: any;
        switch (motorID) {
        case BoostMotorLabel.A:
            motors = [BoostPort.A];
