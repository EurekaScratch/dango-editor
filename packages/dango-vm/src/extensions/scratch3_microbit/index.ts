 ...
 */
class Scratch3MicroBitBlocks implements StandardScratchExtensionClass {
    _peripheral: any;
    runtime: any;
    /**
     ...
     */
    displaySymbol (args: any) {
        const symbol = cast.toString(args.MATRIX).replace(/\s/g, '');
        const reducer = (accumulator: any, c: any, index: any) => {
