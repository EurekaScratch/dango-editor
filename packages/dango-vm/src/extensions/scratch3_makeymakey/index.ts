 ...
 * @constructor
 */
class Scratch3MakeyMakeyBlocks implements StandardScratchExtensionClass {
    frameToggle: any;
    keyPressBuffer: any;
    runtime: any;
    sequences: any;
    ...
    */
     ...
     */
    buildSequenceMenu (sequencesArray: any) {
        return sequencesArray.map((str: any) => this.getMenuItemForSequenceString(str));
    }
    /*
    ...
    getMenuItemForSequenceString (sequenceString: any) {
        ...
        sequenceArray = sequenceArray.map((str: any) => this.KEY_TEXT_SHORT[str]);
        return {
     ...
     */
    whenMakeyKeyPressed (args: any, util: any) {
        let key = args.KEY;
     ...
     */
    addSequence (sequenceString: any, sequenceArray: any) {
