 ...
 * @constructor
 */
class Scratch3PenBlocks implements StandardScratchExtensionClass {
    _penDrawableId: any;
    _penSkinId: any;
    runtime: any;
     ...
     * @private
     */
    _clampPenSize (requestedSize: any) {
     ...
     * @private
     */
    _onTargetCreated (newTarget: any, sourceTarget: any) {
        if (sourceTarget) {
     ...
     * @private
     */
    _onTargetMoved (target: any, oldX: any, oldY: any, isForce: any) {
     ...
     * @private
     */
    _alphaToTransparency (alpha: any) {
     ...
     * @private
     */
    _transparencyToAlpha (transparency: any) {
     ...
     * @param {object} util - utility object provided by the runtime.
     */
    setPenColorToColor (args: any, util: any) {
        this._setPenColorToColor(args.COLOR, util.target);
    }
    _setPenColorToColor (color: any, target: any) {
        const penState = this._getPenState(target);
        ...
        if (rgb.hasOwnProperty('a')) {
            // @ts-expect-error TS(2339): Property 'a' does not exist on type 'RGBObject | {... Remove this comment to see the full error message
     ...
     * @private
     */
    _setOrChangeColorParam (param: any, value: any, penState: any, change: any) {
        switch (param) {
     ...
     * @param {object} util - utility object provided by the runtime.
     */
    changePenColorParamBy (args: any, util: any) {
     ...
     * @param {object} util - utility object provided by the runtime.
     */
    setPenColorParamTo (args: any, util: any) {
        const penState = this._getPenState(util.target);
     ...
     * @param {object} util - utility object provided by the runtime.
     */
    changePenSizeBy (args: any, util: any) {
        this._changePenSizeBy(Cast.toNumber(args.SIZE), util.target);
    }
    _changePenSizeBy (size: any, target: any) {
     ...
     * @param {object} util - utility object provided by the runtime.
     */
    setPenSizeTo (args: any, util: any) {
        this._setPenSizeTo(Cast.toNumber(args.SIZE), util.target);
    }
    _setPenSizeTo (size: any, target: any) {
        const penAttributes = this._getPenState(target).penAttributes;
     ...
     * @param {object} util - utility object provided by the runtime.
     */
    setPenHueToNumber (args: any, util: any) {
        this._setPenHueToNumber(Cast.toNumber(args.HUE), util.target);
    }
    _setPenHueToNumber (hueValue: any, target: any) {
        const penState = this._getPenState(target);
     ...
     * @param {object} util - utility object provided by the runtime.
     */
    changePenHueBy (args: any, util: any) {
        this._changePenHueBy(Cast.toNumber(args.HUE), util.target);
    }
    _changePenHueBy (hueChange: any, target: any) {
        const penState = this._getPenState(target);
     ...
     * @param {object} util - utility object provided by the runtime.
     */
    setPenShadeToNumber (args: any, util: any) {
        this._setPenShadeToNumber(Cast.toNumber(args.SHADE), util.target);
    }
    _setPenShadeToNumber (shade: any, target: any) {
        const penState = this._getPenState(target);
     ...
     * @param {object} util - utility object provided by the runtime.
     */
    changePenShadeBy (args: any, util: any) {
        this._changePenShadeBy(args.SHADE, util.target);
    }
    _changePenShadeBy (shade: any, target: any) {
        const penState = this._getPenState(target);
     ...
     * @private
     */
    _legacyUpdatePenColor (penState: any) {
