...
class WeDo2Motor {
    ...
    _isOn: any;
    _parent: any;
    _pendingTimeoutDelay: any;
    _pendingTimeoutId: any;
    _pendingTimeoutStartTime: any;
    _power: any;
    /**
     ...
     * @private
     */
    _setNewTimeout (callback: any, delay: any) {
        this._clearTimeout();
...
class WeDo2 {
     ...
     */
    playTone (tone: any, milliseconds: any) {
     ...
     */
    generateOutputCommand (connectID: any, commandID: any, values = null) {
     ...
     */
    generateInputCommand (connectID: any, type: any, mode: any, delta: any, units: any, enableNotifications: any) {
        const command = [
            1,
            2,
            connectID,
     ...
     * @private
     */
    _registerSensorOrMotor (connectID: any, type: any) {
 ...
 */
class Scratch3WeDo2Blocks implements StandardScratchExtensionClass {
    _peripheral: any;
    runtime: any;
    /**
