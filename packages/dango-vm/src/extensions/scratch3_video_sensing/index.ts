 ...
 * @constructor
 */
class Scratch3VideoSensingBlocks implements StandardScratchExtensionClass {
    _lastUpdate: any;
    detect: any;
    firstInstall: any;
    runtime: any;
    ...
    set globalVideoTransparency (transparency) {
        ...
        // @ts-expect-error TS(2408): Setters cannot return a value.
        return transparency;
    }
    /**
     ...
     */
    _analyzeLocalMotion (target: any) {
     ...
     *   reference
     */
    whenMotionGreaterThan (args: any, util: any) {
        this.detect.analyzeFrame();
