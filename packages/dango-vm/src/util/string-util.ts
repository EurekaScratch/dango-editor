import log from './log';
class StringUtil {
    static withoutTrailingDigits (s: any) {
        let i = s.length - 1;
    ...
    static unusedName (name: any, existingNames: any) {
     ...
     * splitFirst('foo.', '.');
     */
    static splitFirst (text: any, separator: any) {
     ...
     */
    static replaceUnsafeChars (unsafe: any) {
