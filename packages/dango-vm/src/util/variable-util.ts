class VariableUtil {
    static _mergeVarRefObjects (accum: any, obj2: any) {
     ...
     * the variable.
     */
    static getAllVarRefsForTargets (targets: any, shouldIncludeBroadcast: any) {
        return targets
            .map((t: any) => t.blocks.getAllVariableAndListReferences(null, shouldIncludeBroadcast))
     ...
     */
    static updateVariableIdentifiers (referencesToUpdate: any, newId: any, optNewName: any) {
