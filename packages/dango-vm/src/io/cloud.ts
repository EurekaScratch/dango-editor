...
class Cloud {
    ...
    requestCreateVariable (variable: any) {
     ...
     */
    requestUpdateVariable (name: any, value: any) {
        if (this.provider) {
     ...
     */
    requestRenameVariable (oldName: any, newName: any) {
        if (this.provider) {
     ...
     */
    requestDeleteVariable (name: any) {
        if (this.provider) {
     ...
     */
    updateCloudVariable (varUpdate: any) {
