...
const roundToThreeDecimals = (number: any) => Math.round(number * 1000) / 1000;
class Mouse {
    _buttons: any;
    _clientX: any;
    _clientY: any;
