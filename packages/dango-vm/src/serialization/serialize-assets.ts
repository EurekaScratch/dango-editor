 ...
 */
const serializeAssets = function (runtime: any, assetType: any, optTargetId: any) {
 ...
 */
const serializeSounds = function (runtime: any, optTargetId: any) {
 ...
 */
const serializeCostumes = function (runtime: any, optTargetId: any) {
