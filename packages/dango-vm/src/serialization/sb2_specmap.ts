...
const specMap = {
    ...
    // @ts-expect-error TS(7031): Binding element 'sensor' implicitly has an 'any' t... Remove this comment to see the full error message
 ...
 */
const addExtensionOp = function (sb2Extension: any, sb2Opcode: any, blockInfo: any) {
    /**
