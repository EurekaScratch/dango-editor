...
class Scratch3SoundBlocks {
    ...
    getSoundIndexByName (soundName: any, util: any) {
    ...
    _stopAllSoundsForTarget (target: any) {
    ...
    _stopWaitingSoundsForTarget (target: any) {
        if (target.sprite.soundBank) {
            if (this.waitingSounds[target.id]) {
    ...
    _updateEffect (args: any, util: any, change: any) {
    ...
    _syncEffectsForTarget (target: any) {
    ...
    _clearEffectsForTarget (target: any) {
