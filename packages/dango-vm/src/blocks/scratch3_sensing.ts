...
class Scratch3SensingBlocks {
    ...
    getMonitored () {
        return {
            ...
            sensing_current: {
                ...
                getId: (_: any, fields: any) => getMonitorIdForBlockWithArgs('current', fields) // _${param}`
            }
        };
    }
    _onAnswer (answer: any) {
        this._answer = answer;
    ...
    _enqueueAsk (question: any, resolve: any, target: any, wasVisible: any, wasStage: any) {
    ...
    _clearTargetQuestions (stopTarget: any) {
        const currentlyAsking = this._questionList.length > 0 && this._questionList[0][2] === stopTarget;
        this._questionList = this._questionList.filter((question: any) => question[2] !== stopTarget);
        if (currentlyAsking) {
    ...
    setDragMode (args: any, util: any) {
        util.target.setDraggable(args.DRAG_MODE === 'draggable');
    }
    getTimer (args: any, util: any) {
        return util.ioQuery('clock', 'projectTimer');
    }
    resetTimer (args: any, util: any) {
        util.ioQuery('clock', 'resetProjectTimer');
    }
    getMouseX (args: any, util: any) {
        return util.ioQuery('mouse', 'getScratchX');
    }
    getMouseY (args: any, util: any) {
        return util.ioQuery('mouse', 'getScratchY');
    }
    getMouseDown (args: any, util: any) {
    ...
    getKeyPressed (args: any, util: any) {
