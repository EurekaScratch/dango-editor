...
class LoadingProgress {
    ...
    on (storage, vm) {
        ...
        storage.webHelper.load = function (...args) {
            ...
            result.then(() => {
                if (_this.dataLoaded === 0) {
                    ...
                    // @ts-expect-error TS(2339): Property 'ScratchVMLoadDataEnd' does not exist on ... Remove this comment to see the full error message
                ...
                if (_this.contentComplete && _this.contentComplete === _this.contentTotal) {
                    ...
                    // @ts-expect-error TS(2339): Property 'ScratchVMDownloadEnd' does not exist on ... Remove this comment to see the full error message
        ...
        vm.runtime.on(Runtime.PROJECT_LOADED, () => {
            ...
            // @ts-expect-error TS(2339): Property 'ScratchVMLoadEnd' does not exist on type... Remove this comment to see the full error message
...
class FramesTable extends StatTable {
    ...
    // @ts-expect-error TS(2425): Class 'StatTable' defines instance member property... Remove this comment to see the full error message
    keys () {
...
// @ts-expect-error TS(2451): Cannot redeclare block-scoped variable 'onload'.
